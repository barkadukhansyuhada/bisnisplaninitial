...
const seedItems: DataItem[] = [
  // Geology — prefilled
  {
    ...
    friendlyTitle: "Pemetaan Struktur Bawah Tanah",
    details:
  ...
  },
  {
    ...
    friendlyTitle: "Titik Lokasi Survei Geologi",
  ...
  },
  {
    ...
    friendlyTitle: "Rencana Pengeboran Untuk Sampel Batuan",
  ...
  // QC
  {
    ...
    friendlyTitle: "Uji Ketahanan Batuan Terhadap Benturan",
  ...
  },
  {
    ...
    friendlyTitle: "Ringkasan Hasil Uji Laboratorium Batuan",
  ...
  { 
    id: "sieve", 
    domain: "qc", 
    title: "Sieve analysis per fraksi", 
    friendlyTitle: "Analisis Ukuran Butiran Batuan",
    details: "Gradasi 1–2; 2–3; 3–5; screening; abu.", 
    unit: "XLSX", 
    status: "missing", 
    source: "QC rencana", 
    owner: "QC Lab", 
  ...
  { 
    id: "asr", 
    domain: "qc", 
    title: "Potensi ASR/Soundness/Flakiness", 
    friendlyTitle: "Uji Kualitas Batuan untuk Konstruksi",
    details: "SNI relevan untuk proyek jalan & beton.", 
    unit: "PDF", 
    status: "missing", 
    source: "QC lanjutan", 
    owner: "QC Lab", 
  ...
  { 
    id: "pit_design", 
    domain: "mine", 
    title: "Desain pit & jenjang", 
    friendlyTitle: "Rancangan Tambang dan Tangga Penambangan",
    details: "Bench 5–10 m; ramp; berm; FoS geotek.", 
    unit: "DXF/DWG", 
    status: "missing", 
    source: "Geotek & design", 
    owner: "Mine Eng", 
    priority: "High" 
  },
  { 
    id: "drainage", 
    domain: "mine", 
    title: "Drainase & settling pond", 
    friendlyTitle: "Sistem Pembuangan Air dan Kolam Pengendapan",
    details: "Parit perimeter; kolam bertingkat; spillway.", 
    unit: "Layout", 
    status: "missing", 
    source: "Hidrologi", 
    owner: "Mine Eng", 
  ...
  { 
    id: "flowsheet", 
    domain: "plant", 
    title: "Flowsheet pabrik 250 tph", 
    friendlyTitle: "Diagram Alur Proses Pabrik Pemecah Batu",
    details: "Jaw → Secondary → Screen; OEE target; dust control.", 
    unit: "PFD", 
    status: "missing", 
    source: "Vendor", 
    owner: "Process Eng", 
  ...
  { 
    id: "genset_admin", 
    domain: "plant", 
    title: "Genset admin 60 kVA (ATS)", 
    friendlyTitle: "Generator Listrik Cadangan untuk Kantor",
    details: "Jam cadangan ±1.000/tahun; ~0,27 L/kWh.", 
    unit: "Spec", 
    status: "available", 
    source: "Asumsi proyek", 
    owner: "Facility", 
    priority: "Low" 
  },
  // Ops
  { 
    id: "fleet_list", 
    domain: "ops", 
    title: "Fleet inti (2×PC200; 7×DT idx 25; 1×Loader)", 
    friendlyTitle: "Daftar Alat Berat untuk Operasional",
    details: "Jam/avail/util; BBM/jam.", 
    unit: "XLSX", 
    status: "available", 
    source: "Input pemilik", 
    owner: "Operations", 
    priority: "Low" 
  },
  { 
    id: "cycle_time", 
    domain: "ops", 
    title: "Siklus & jarak angkut", 
    friendlyTitle: "Waktu dan Jarak Pengangkutan Material",
    details: "Loading → hauling → dumping; rute satu arah.", 
    unit: "Study", 
    status: "missing", 
    source: "Time & motion", 
    owner: "Operations", 
  ...
  { 
    id: "customers", 
    domain: "market", 
    title: "Daftar pelanggan & LOI", 
    friendlyTitle: "Data Calon Pembeli dan Surat Minat",
    details: "Ready‑mix; jalan; precast; volume bulanan.", 
    unit: "XLSX", 
    status: "missing", 
    source: "Sales", 
    owner: "Sales", 
  ...
  { 
    id: "pricing", 
    domain: "market", 
    title: "Harga per fraksi & matriks jarak ≤50 km", 
    friendlyTitle: "Daftar Harga Produk dan Ongkos Kirim",
    details: "Ex‑plant Rp120k/m³ (mix); delivered by radius.", 
    unit: "XLSX", 
    status: "missing", 
    source: "Komersial", 
    owner: "Sales", 
  ...
  { 
    id: "capex_quotes", 
    domain: "finance", 
    title: "Kutipan CAPEX vendor", 
    friendlyTitle: "Penawaran Harga Investasi Peralatan",
    details: "Crusher, timbangan, genset, workshop, jalan.", 
    unit: "PDF", 
    status: "missing", 
    source: "Vendor", 
    owner: "Finance", 
  ...
  { 
    id: "opex_detail", 
    domain: "finance", 
    title: "Detail OPEX (BBM, listrik, peledak, spare)", 
    friendlyTitle: "Rincian Biaya Operasional Harian",
    details: "BBM Rp10.000/L; grid Rp1.444/kWh.", 
    unit: "XLSX", 
    status: "available", 
    source: "Model v3", 
    owner: "Finance", 
  ...
  { 
    id: "permits_plan", 
    domain: "permits", 
    title: "Roadmap Perizinan (AMDAL, SIPB, RKAB, SMKP)", 
    friendlyTitle: "Jadwal Pengurusan Izin Operasional",
    details: "Target izin 2026; urutan & prasyarat.", 
    unit: "Checklist", 
    status: "available", 
    source: "Rencana proyek", 
    owner: "Permitting", 
    priority: "High" 
  },
  { 
    id: "baseline_env", 
    domain: "permits", 
    title: "Baseline lingkungan (air, TSP/PM10, noise, getaran)", 
    friendlyTitle: "Data Kondisi Lingkungan Sebelum Tambang",
    details: "Lokasi & frekuensi monitoring.", 
    unit: "CSV/PDF", 
    status: "missing", 
    source: "Konsultan AMDAL", 
    owner: "Enviro", 
    priority: "High" 
  },
  // Governance
  { 
    id: "gantt", 
    domain: "governance", 
    title: "Gantt 18 bulan & critical path", 
    friendlyTitle: "Jadwal Proyek dan Aktivitas Penting",
    details: "Pemboran→Lingkungan→SIPB→RKAB→Konstruksi.", 
    unit: "PNG/MPP", 
    status: "available", 
    source: "Rencana proyek", 
    owner: "PMO", 
  ...
  { 
    id: "sop", 
    domain: "governance", 
    title: "SOP kritikal & ERP", 
    friendlyTitle: "Prosedur Kerja dan Rencana Tanggap Darurat",
    details: "Peledakan, muat‑angkut, crusher, izin kerja, tanggap darurat.", 
    unit: "DOCX/PDF", 
    status: "missing", 
    source: "SMKP", 
    owner: "HSE", 
...
interface AppState {
  ...
  setFriendlyTitle: (id: string, friendlyTitle: string) => void;
...
export const useStore = create<AppState>()(
  persist(
    (set, get) => ({
      ...
      setFriendlyTitle: (id, friendlyTitle) =>
        set((state) => ({ items: state.items.map((i) => (i.id === id ? { ...i, friendlyTitle } : i))})),
      addItem: (partial) =>
        set((state) => ({
          items: [
            {
              ...
              friendlyTitle: partial.friendlyTitle || "Item Baru",
